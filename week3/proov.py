def leia_suurim(uus, senine_max):
    ...
    return uus if uus > senine_max else senine_max

def kas_suurem_kui_50(arv):
    """Tagastab True, kui arv on suurem kui 50."""
    return arv > 50 #return arvuti jaoks mitte kasutaja
...
def main():
    ...
    while True:
        kasutaja_sisend = input("Sisesta arv (või 'lõpp'): ").lower()
    ...
    if arv_kokku == 0:
        ...
        print(f"Arve, mis olid suuremad kui 50: {yle_viiekymne}")
