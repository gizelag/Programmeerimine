...
def joonista_kolmnurk():
    """joonistab punase kolmnurga asukohas -150, 0 ja kasutab for tsukklit"""
    turtle.goto(-150,0)
    turtle.color('red')
...
def joonista_ruut():
    """joonistab sinise ruudu asukohas -50, 0 ja kasutab for tsukklit"""
...
def joonista_viisnurk():
    ...
    for i in range(5):
        #5 kulge ja 250 uhikut ja 72kraadi
        turtle.forward(250)
        turtle.left(72)

def main():
    #pohifunktsioon mis joonistab koik kujundid
